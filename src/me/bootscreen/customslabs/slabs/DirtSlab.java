...
public class DirtSlab extends GenericCuboidCustomBlock
{
    ...
    {
        super(plugin, plugin.getConfig().getString("dirt.name", "Dirt Slab"), 44, new GenericCuboidBlockDesign(plugin, texture, new int[] {1,0,0,0,0,1}, 0.0F, 0.0F, 0.0F, 1.0F, 0.5F, 1.0F));
