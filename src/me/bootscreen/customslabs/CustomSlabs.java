...
public class CustomSlabs extends JavaPlugin 
{
	...
	public void onEnable() {
		...
		{
			GrassTexture = new Texture(this,config.getString("grass.url","http://webspace.hinchy.us/cb/CustomSlabsTextures/grass.png"),config.getInt("grass.size",16) * 2, config.getInt("grass.size",16)  * 2, config.getInt("grass.size",16));
			GrassSlab = new GrassSlab (this, GrassTexture);
			GrassTopSlab = new GrassTopSlab (this, GrassTexture);
	...
	public void loadConfig()
	{
		...
		config.addDefault("bedrock.name.normal","Bedrock Slab");
		config.addDefault("bedrock.name.top","Bedrock TopSlab (DO NOT USE)");
		...
		config.addDefault("bookshelf.name.normal","Bookshelf Slab");
		config.addDefault("bookshelf.name.top","Bookshelf TopSlab (DO NOT USE)");
		...
		config.addDefault("clay.name.normal","Clay Slab");
		config.addDefault("clay.name.top","Clay TopSlab (DO NOT USE)");
		...
		config.addDefault("dirt.name.normal","Dirt Slab");
		config.addDefault("dirt.name.top","Dirt TopSlab (DO NOT USE)");
		...
		config.addDefault("grass.name.normal","Grass Slab");
		config.addDefault("grass.name.top","Grass TopSlab (DO NOT USE)");
		...
		config.addDefault("endstone.name.normal","End Stone Slab");
		config.addDefault("endstone.name.top","End Stone TopSlab (DO NOT USE)");
		...
		config.addDefault("glas.name.normal","Glass Slab");
		config.addDefault("glas.name.top","Glass TopSlab (DO NOT USE)");
		...
		config.addDefault("glowstone.name.normal","Glowstone Slab");
		config.addDefault("glowstone.name.top","Glowstone TopSlab (DO NOT USE)");
		...
		config.addDefault("gravel.name.normal","Gravel Slab");
		config.addDefault("gravel.name.top","Gravel TopSlab (DO NOT USE)");
		...
		config.addDefault("lapislazuli.name.normal","Lapis Lazuli Slab");
		config.addDefault("lapislazuli.name.top","Lapis Lazuli TopSlab (DO NOT USE)");
		...
		config.addDefault("log.name.normal","Log Slab");
		config.addDefault("log.name.top","Log TopSlab (DO NOT USE)");
		...
		config.addDefault("log1.name.normal","Spruce Log Slab");
		config.addDefault("log1.name.top","Spruce Log TopSlab (DO NOT USE)");
		...
		config.addDefault("log2.name.normal","Birch Log Slab");
		config.addDefault("log2.name.top","Birch Log TopSlab (DO NOT USE)");
		...
		config.addDefault("log3.name.normal","Jungle Log Slab");
		config.addDefault("log3.name.top","Jungle Log TopSlab (DO NOT USE)");
		...
		config.addDefault("mossstone.name.normal","Moss Stone Slab");
		config.addDefault("mossstone.name.top","Moss Stone TopSlab (DO NOT USE)");
		...
		config.addDefault("netherbrick.name.normal","Nether Brick Slab");
		config.addDefault("netherbrick.name.top","Nether Brick TopSlab (DO NOT USE)");
		...
		config.addDefault("netherrack.name.normal","Netherrack Slab");
		config.addDefault("netherrack.name.top","Netherrack TopSlab (DO NOT USE)");
		...
		config.addDefault("obsidian.name.normal","Obsidian Slab");
		config.addDefault("obsidian.name.top","Obsidian TopSlab (DO NOT USE)");
		...
		config.addDefault("sand.name.normal","Sand Slab");
		config.addDefault("sand.name.top","Sand TopSlab (DO NOT USE)");
		...
		config.addDefault("soulsand.name.normal","Soul Sand Slab");
		config.addDefault("soulsand.name.top","Soul Sand TopSlab (DO NOT USE)");
		...
		config.addDefault("stonebrick.cracked.name.normal","Cracked Stone Brick Slab");
		config.addDefault("stonebrick.cracked.name.top","Cracked Stone Brick TopSlab (DO NOT USE)");
		...
		config.addDefault("stonebrick.mossy.name.normal","Mossy Stone Brick Slab");
		config.addDefault("stonebrick.mossy.name.top","Mossy Stone Brick TopSlab (DO NOT USE)");
		...
		config.addDefault("clean_stone.name.normal","Clean Stone Slab");
		config.addDefault("clean_stone.name.top","Clean Stone TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.black.name.normal","Black Wool Slab");
		config.addDefault("wool.black.name.top","Black Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.blue.name.normal","Blue Wool Slab");
		config.addDefault("wool.blue.name.top","Blue Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.brown.name.normal","Brown Wool Slab");
		config.addDefault("wool.brown.name.top","Brown Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.cyan.name.normal","Cyan Wool Slab");
		config.addDefault("wool.cyan.name.top","Cyan Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.gray.name.normal","Grey Wool Slab");
		config.addDefault("wool.gray.name.top","Grey Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.green.name.normal","Dark Green Slab");
		config.addDefault("wool.green.name.top","Dark Green TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.lightblue.name.normal","Light Blue Wool Slab");
		config.addDefault("wool.lightblue.name.top","Light Blue Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.lightgray.name.normal","Light Grey Wool Slab");
		config.addDefault("wool.lightgray.name.top","Light Grey Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.lime.name.normal","Light Green Wool Slab");
		config.addDefault("wool.lime.name.top","Light Green Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.magenta.name.normal","Magenta Wool Slab");
		config.addDefault("wool.magenta.name.top","Magenta Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.orange.name.normal","Orange Wool Slab");
		config.addDefault("wool.orange.name.top","Orange Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.pink.name.normal","Pink Wool Slab");
		config.addDefault("wool.pink.name.top","Pink Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.purple.name.normal","Purple Wool Slab");
		config.addDefault("wool.purple.name.top","Purple Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.red.name.normal","Red Wool Slab");
		config.addDefault("wool.red.name.top","Red Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.white.name.normal","White Wool Slab");
		config.addDefault("wool.white.name.top","White Wool TopSlab (DO NOT USE)");
		...
		config.addDefault("wool.yellow.name.normal","Yellow Wool Slab");
		config.addDefault("wool.yellow.name.top","Yellow Wool TopSlab (DO NOT USE)");
