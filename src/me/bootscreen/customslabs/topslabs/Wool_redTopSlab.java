...
public class Wool_redTopSlab extends GenericCuboidCustomBlock
{
    ...
    {
        super(plugin, plugin.getConfig().getString("wool.red.name.top", "Red Wool TopSlab"), 44, 8, new  GenericCuboidBlockDesign(plugin, texture, new int[] {1,0,0,0,0,1}, 0.0F, 0.5F, 0.0F, 1.0F, 1.0F, 1.0F));
